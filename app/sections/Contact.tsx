  ...
  return (
    ...
    >
      ...
      <div className="mx-auto  flex w-[90%] flex-col items-center justify-center pt-10 md:pt-0">
        <div
          className={`flex flex-col items-end justify-center pr-5 sm:pr-0 ${spaceGrotesk.className} relative w-full sm:items-center lg:max-w-[1440px] `}
        >
          <AnimatedWords
            title={"contact"}
            style={
              "flex max-w-[400px] flex-col items-end text-right text-[75px] font-extrabold uppercase leading-[2em] md:leading-[0.8em] text-[#e4ded7] sm:max-w-full sm:flex-row sm:items-center sm:justify-center sm:text-center sm:text-[150px] md:text-[200px] lg:text-center lg:text-[250px] xl:text-[290px] mr-[-2rem] "
            }
          />
        </div>
        ...
        <div className="mt-20 flex w-full flex-col items-end justify-center gap-16 sm:mt-32 sm:gap-12 md:mt-40 md:flex-row md:items-start md:justify-between lg:mt-12 lg:max-w-[1440px]">
          <div className=" flex w-[350px] max-w-[90%] flex-col items-end text-right text-[14px] font-semibold uppercase text-[#e4ded7] sm:w-[350px] sm:text-[14px] md:w-[310px] md:items-start md:text-left md:text-[16px] lg:w-[420px] lg:text-[16px]">
            ...
            />
            <Link
              href="mailto: keshavdhawan2002@gmail.com"
              target="_blank"
          ...
          <div className="flex gap-5 text-[10px] font-bold text-[#e4ded7]  sm:gap-14 sm:text-[24px] md:gap-10 md:text-[16px] lg:gap-20 lg:text-[28px]">
            <Link
              href="https://github.com/itskdbro"
              target="_blank"
            ...
            <Link
              href="https://www.linkedin.com/in/keshav-dhawan-059967266/"
              target="_blank"
            ...
            <Link
              href="https://www.instagram.com/its_k.d_bro?igsh=MWE3dXRmeW8xbTds"
              target="_blank"
